...
const fr = {
  ...
  home: {
    ...
    valueB_title: "Esprit de partage", valueB_text: "Donnez gratuitement ou vendez à prix juste. La plateforme est gratuite.",
  ...
  about: {
    ...
    b_title: "Encourager le don", b_text: "Donner ses livres, c'est offrir une geste qui profite à toute la communauté.",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Puis-je donner un livre gratuitement ?", a: "Bien sûr ! Lors de la publication, cochez l'option « Don ». Votre annonce apparaîtra avec le badge Don." },
...
const en = {
  ...
  home: {
    ...
    valueB_title: "Sharing spirit", valueB_text: "Give for free or sell at fair price. The platform is free.",
  ...
  about: {
    ...
    b_title: "Encourage giving", b_text: "Giving away your books is offering an gift that benefits the whole community.",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Can I give a book for free?", a: "Of course! When publishing, check the “Donation” option. Your listing will appear with the Donation badge." },
...
const ar = {
  ...
  home: {
    ...
    valueB_title: "روح العطاء", valueB_text: "تبرع مجانًا أو بِع بسعر عادل. المنصة مجانية.",
...
const es = {
  ...
  home: {
    ...
    valueB_title: "Espíritu de compartir", valueB_text: "Dona gratis o vende a un precio justo. La plataforma es gratuita.",
...
const it = {
  ...
  home: {
    ...
    valueB_title: "Spirito di condivisione", valueB_text: "Dona gratuitamente o vendi a un prezzo equo. La piattaforma è gratuita.",
